...
import { publicMarketingRouter } from './modules/publicMarketing.js';
...
export const createApp = () => {
  ...
  // Marketing site: images, FAQs, contact details, open roles, store badges,
  // the sign-up consent line and the contact form. Same mount, own limiters.
  app.use('/api/v1/public', publicMarketingRouter);
